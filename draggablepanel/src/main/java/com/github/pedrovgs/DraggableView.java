...
public class DraggableView extends RelativeLayout
    ...
    private static final boolean DEFAULT_CLOSED_BY_HORIZONTAL_SLIDE = true;
    ...
    private boolean isClosedByHorizontalSlide;

    private List<DraggableListener> listeners;
     ...
     */
    public void addDraggableListener(DraggableListener listener) {
        this.listeners.add(listener);
    }

    public void addDraggableListeners(List<DraggableListener> listeners) {
    ...
    private void notifyMaximizeToListener() {
        for (DraggableListener listener : listeners) {
    ...
    public boolean isClosedByHorizontalSlide() {
        return isClosedByHorizontalSlide;
    }

    public void setClosedByHorizontalSlide(boolean closedByHorizontalSlide) {
        isClosedByHorizontalSlide = closedByHorizontalSlide;
    }
